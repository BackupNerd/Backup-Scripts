...
# ----- Functions ----
    ...
    Function Set-APICredentials {
        ...
        DO{ $PartnerName = Read-Host -assecurestring "  Enter Login Partner Name" }
        WHILE ($partnerName.length -eq 0)
            $PartnerName | convertfrom-securestring -ErrorAction SilentlyContinue | out-file $APIcredfile
