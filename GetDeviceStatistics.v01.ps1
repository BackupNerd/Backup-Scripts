...
#region ----- Backup.Management JSON Calls ----
    ...
    if($null -eq $SelectedDevices) {
        ...
        # OK was pressed, $Selection contains what was chosen
        # Run OK script
        $script:SelectedDevices |  Select-Object PartnerName,AccountID,DeviceName,ComputerName,Creation,TimeStamp,LastSuccess,Product,Profile,DataSources,SelectedGB,UsedGB,Location,OS,OSType  | Sort-object PartnerName,AccountId | export-csv
