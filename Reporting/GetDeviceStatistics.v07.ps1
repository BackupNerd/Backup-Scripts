<# ----- About: ----
    # Get N-able Backup Device Statistics 
    # Revision v07 - 2021-06-24
...
#region ----- Environment, Variables, Names and Paths ----
    Clear-Host
    $ConsoleTitle = "Get Device Statistics"
...
#region ----- Backup.Management JSON Calls ----
    ...
    Function Send-GetDevices {
        ...
        $data.params.query.Columns = @("AU","AR","AN","MN","AL","LN","OP","OI","OS","OT","PD","AP","PF","PN","CD","TS","TL","T3","US","TB","I81","AA843","AA77","AA2048")
    ...
    if ($AllDevices) {
        $script:SelectedDevices = $DeviceDetail | Select-Object PartnerId,PartnerName,Reference,AccountID,DeviceName,ComputerName,Creation,TimeStamp,LastSuccess,Last28Days,ProductId,Product,ProfileId,Profile,DataSources,SelectedGB,UsedGB,Location,OS,OSType,Physicality
    }else{
        $script:SelectedDevices = $DeviceDetail | Select-Object PartnerId,PartnerName,Reference,AccountID,DeviceName,ComputerName,Creation,TimeStamp,LastSuccess,Last28Days,ProductId,Product,ProfileId,Profile,DataSources,SelectedGB,UsedGB,Location,OS,OSType,Physicality | Out-GridView -title "Current Partner | $partnername" -OutputMode Multiple}
    ...
    if($null -eq $SelectedDevices) {
        ...
        # OK was pressed, $Selection contains what was chosen
        # Run OK script
        $DeviceDetail | Select-Object PartnerName,AccountID,DeviceName,ComputerName,Creation,TimeStamp,LastSuccess,Last28,Product,Profile,DataSources,SelectedGB,UsedGB,Location,OS,OSType,Physicality  | Sort-object PartnerName,AccountId | format-table
