...
#region ----- Backup.Management JSON Calls ----
    ...
    Function Join-Reports {
        ...
        $Script:M365Users = Join-Object -left $script:M365UserStatistics -LeftJoinProperty UserGuid -right $script:devicestatistics -RightJoinProperty UserGuid -Prefix 'Prot_' -Type AllInLeft -RightProperties Billable,Mailbox,OneDrive,SharePoint
