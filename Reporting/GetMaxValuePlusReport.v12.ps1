# ----- About: ----
    # N-able Backup Get MaxValue Plus Report  
    # Revision v12 - 2021-08-02
...
#region ----- Backup.Management JSON Calls ----
    ...
    Function Send-GetDevices {
        ...
        $data.params.query.Columns = @("AU","AR","AN","MN","AL","LN","OP","OI","OS","OT","PD","AP","PF","PN","CD","TS","TL","T3","US","I81","AA843","AA77","AA2048","AA2068","AA2069")
        ...
        $Script:DeviceDetail += New-Object -TypeName PSObject -Property @{ AccountID      = [Int]$DeviceResult.AccountId;
                                                                    ...
                                                                    STAT_4         = Convert-UnixTimeToDateTime ($DeviceResult.Settings.AA2068 -join '') ;
                                                                    STAT_5         = $DeviceResult.Settings.AA2069 -join '' ;                                                                        
