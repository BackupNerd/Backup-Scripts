...
<# ----- Behavior: ----
    ...
    # [-Redeploy]                                                  ## D\L then upgrade existing Backup Manager installation to the latest Backup Manager release
    # [-Upgrade]                                                   ## D\L then install\reinstall with PrivateKey Encryption or PassPhrase (supports [-RestoreOnly] mode) 
