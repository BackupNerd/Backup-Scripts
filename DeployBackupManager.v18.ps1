<# ----- About: ----
    # SolarWinds Backup Deploy Backup Manager
    # Revision v18 - 2020-12-24
...
<# ----- Behavior: ----
    ...
    # [-AutoDeploy] [-Uid] <string> [-Takeover]                    
        ## D\L then take ownership of existing Backup Manager and convert to Passphrase compatible device
    # [-AutoDeploy] [-Uid] <string> [-Takeover] [-Alias <string>]  
        ## D\L take ownership, convert to passphrase and set a device name Alias for existing Backup Manager device
    # [-Redeploy]                                                  
    ...
    # https://documentation.solarwindsmsp.com/backup/documentation/Content/backup-manager/backup-manager-installation/silent.htm
    # https://documentation.solarwindsmsp.com/backup/documentation/Content/backup-manager/backup-manager-installation/reinstallation.htm
# -----------------------------------------------------------#>
