<# ----- About: ----
    # Export Cove Customer UID for Deploy and to Convert to PassPhrase Commands
    # Revision v04 - 2022-08-29
...
<# ----- Behavior: ----
    ...
    # Replace the 'PROFILEID' portion of the Silent Installer CMD with a '0' for No Profile or a valid PROFILEID
    #
    ...
    # https://documentation.n-able.com/covedataprotection/USERGUIDE/documentation/Content/backup-manager/backup-manager-installation/convert-to-passphrase.htm
    # https://documentation.n-able.com/covedataprotection/USERGUIDE/documentation/Content/service-management/console/profiles.htm#profile-id
    # https://documentation.n-able.com/covedataprotection/USERGUIDE/documentation/Content/service-management/json-api/home.htm
    # https://documentation.n-able.com/covedataprotection/USERGUIDE/documentation/Content/service-management/json-api/get-customer-info.htm
...
#region ----- Environment, Variables, Names and Paths ----
    Clear-Host
    $ConsoleTitle = "Export Cove Customer UID Related Commands"
...
#region ----- Backup.Management JSON Calls ----
    ...
    Function Send-EnumeratePartners {
        ...
        # (No error)
                ...
                $Script:EnumeratePartnersSessionResults = $EnumeratePartnersSession.result.result | select-object Name,ExternalCode,@{l='Id';e={($_.Id).tostring()}},Level,ParentId,LocationId,Location,*,LocalDeviceCommand2ConvertPrivateKeyEncryption2Passphrase,Win_Silent_Install_CMD_Replace_PROFILEID_or_Use_0_for_No_Profile,Mac_Silent_Install_CMD_Replace_PROFILEID_or_Use_0_for_No_Profile,Linux_Silent_Install_CMD_Replace_PROFILEID_or_Use_0_for_No_Profile -ExcludeProperty Company,AdvancedPartnerProperties,ExternalPartnerProperties,Flags,RegistrationOrigin,TrialRegistrationTime,TrialExpirationTime -ErrorAction Ignore
                ...
                $Script:EnumeratePartnersSessionResults | ForEach-Object { $_.LocalDeviceCommand2ConvertPrivateKeyEncryption2Passphrase = $Convert2Passphrase_cmd.Replace("SampleUID","$($_.uid)")}

                $Win_Install_cmd = "bm#SampleUID#PROFILEID#.exe"
                $Script:EnumeratePartnersSessionResults | ForEach-Object { $_.Win_Silent_Install_CMD_Replace_PROFILEID_or_Use_0_for_No_Profile = $Win_Install_cmd.Replace("SampleUID","$($_.uid)")}

                $Mac_Install_cmd = "bm#SampleUID#PROFILEID#.pkg"
                $Script:EnumeratePartnersSessionResults | ForEach-Object { $_.Mac_Silent_Install_CMD_Replace_PROFILEID_or_Use_0_for_No_Profile = $Mac_Install_cmd.Replace("SampleUID","$($_.uid)")}

                $Linux_Install_cmd = "bm#SampleUID#PROFILEID#.run"
                $Script:EnumeratePartnersSessionResults | ForEach-Object { $_.Linux_Silent_Install_CMD_Replace_PROFILEID_or_Use_0_for_No_Profile = $Linux_Install_cmd.Replace("SampleUID","$($_.uid)")}
