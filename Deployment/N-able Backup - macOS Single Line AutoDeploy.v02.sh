...
UID="01d10b9ee-2a24-4868-9ceb-5e3272124cf0"; PROFILEID='128555'; INSTALL="/Applications/bm#$UID#$PROFILEID#.pkg"; curl -o $INSTALL https://cdn.cloudbackup.management/.../mxb-macosx-x86_64.pkg; sudo installer -pkg $INSTALL -target /Applications; rm -f $INSTALL
