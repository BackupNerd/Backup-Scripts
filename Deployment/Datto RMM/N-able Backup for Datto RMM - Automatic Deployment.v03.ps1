...
<# ----- Behavior: ----
    ...
    # Type: Boolean
    # Default: True
    # Description: True to assign a Profile Name
    # Description: False to skip assigning a Profile Name
    #
    # Name: Set_Product
    # Type: Boolean
    # Default: True
    # Description: True to assign a Product Name
    # Description: False to skip assigning a Product Name
    #
    # Name: Profile
    # Type: Variable Value
...
## $env: required to pass external varible from DATTO RMM to script

if ( $env:Set_Product -eq "true" ) { $BackupProduct = "-product-name `"$env:Product`"" } else { $BackupProduct = "-product-name `"All-In`"" }   
## $env: prefix required to pass external varible from DATTO RMM to script
