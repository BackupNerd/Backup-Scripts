<# ----- About: ----
    # N-able Backup for Windows - Automatic Deployment (NinjaOne prototype)
    # Revision v03 - 2023-12-08
...
<# ----- Behavior: ----
    ...
    # Run this Script from the NinjaOne RMM
    #
    # Name: UID
...
$PROFILEID = Ninja-Property-Get covebackupdefaultprofile
$PRODUCT = "Default365"
