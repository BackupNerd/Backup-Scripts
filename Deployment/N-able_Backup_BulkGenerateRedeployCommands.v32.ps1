<# ----- About: ----
    # N-able Backup Bulk Generate Redeploy Commands
    # Revision v32 - 2022-03-02 
...
Write-output "partnername`tostype`tosversion`tcreation`tlastsuccess`ttimestamp`tid`tcomputername`tdevicename`tpassword`tpassphrase`tdownload`tlegacy" | Out-file $csvcommands
