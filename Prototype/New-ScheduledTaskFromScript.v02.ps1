...
<# ----- Behavior: ----
    ...
    # 3. Parses script parameters and provides auto-complete
    # 4. Provides intuitive UI for:
    #    - Task name
    #    - User account (with password)
    #    - Start time and frequency (Once, Daily, Weekly)
    #    - Run whether user is logged on or not
    #    - Run with highest privileges
    # 5. Creates Windows Scheduled Task with specified settings
#>
...
"@
    ...
    $txtScript.Size = New-Object System.Drawing.Size(450, 20)
    $txtScript.ReadOnly = $true
    $form.Controls.Add($txtScript)
    
    $btnBrowse = New-Object System.Windows.Forms.Button
    $btnBrowseY = $yPos - 2
    $btnBrowse.Location = New-Object System.Drawing.Point(590, $btnBrowseY)
    ...
    $grpPSVersion.Size = New-Object System.Drawing.Size(540, 50)
    ...
    $lblPSVersion.Size = New-Object System.Drawing.Size(540, 20)
    ...
    $grpParams.Size = New-Object System.Drawing.Size(650, 240)
    ...
    $panelParams.Size = New-Object System.Drawing.Size(630, 205)
    ...
    $grpTask.Size = New-Object System.Drawing.Size(650, 370)
    ...
    $txtTaskName.Size = New-Object System.Drawing.Size(490, 20)
    ...
    $txtUser.Size = New-Object System.Drawing.Size(490, 20)
    ...
    $txtPassword.Size = New-Object System.Drawing.Size(490, 20)
    ...
    $chkRunLoggedOff.Size = New-Object System.Drawing.Size(490, 20)
    ...
    $chkHighestPrivileges.Size = New-Object System.Drawing.Size(490, 20)
    $chkHighestPrivileges.Text = 'Run with highest privileges'
    $chkHighestPrivileges.Checked = $true
    ...
    $chkRunHidden.Size = New-Object System.Drawing.Size(490, 20)
    $chkRunHidden.Text = 'Run hidden (no PowerShell window - prevents focus stealing)'
    $chkRunHidden.Checked = $true
    ...
    $weekdaysY = $taskYPos + 25
    $clbWeekdays.Location = New-Object System.Drawing.Point(130, $weekdaysY)
    $clbWeekdays.Size = New-Object System.Drawing.Size(490, 70)
    ...
    $btnPreview.Location = New-Object System.Drawing.Point(360, $yPos)
    ...
    $btnCreate.Location = New-Object System.Drawing.Point(460, $yPos)
    ...
    $btnCancel.Location = New-Object System.Drawing.Point(560, $yPos)
        ...
        if ($openFileDialog.ShowDialog() -eq 'OK') {
            ...
            try {
                ...
                foreach ($param in $script:scriptInfo.Parameters) {
                    ...
                    if ($param.ValidateSetValues) {
                    ...
                    } elseif ($param.Type -eq 'Boolean' -or $param.Type -eq 'SwitchParameter') {
                        # Simple true/false — render as checkbox
                        ...
                        $chkParam.Checked = ($param.DefaultValue -eq '$true')
                        ...
                        if ($param.DefaultValue) {
                            ...
                            if ($param.DefaultValue -match '\$PSScriptRoot') {
                                $txtParam.Text = ''
                                $txtParam.PlaceholderText = '(uses $PSScriptRoot from script)'
                            } else {
    ...
    Function Build-CommandArguments {
        ...
        foreach ($paramName in $script:paramControls.Keys) {
            ...
            if ($control -is [System.Windows.Forms.CheckBox]) {
                # Cast to bool explicitly in the command
...
"@
        ...
        $btnTest.Add_Click({
            ...
            if ($testArgs -match '-Command "(.+)"$') {
                ...
                $testArgs = $testArgs -replace [regex]::Escape("-Command `"$commandContent`""), "-NoExit -Command `"$commandContent$postMessage"
            } else {
...
if (-not $isAdmin) {
    Write-Host "`n⚠️ WARNING: This script requires Administrator privileges to create scheduled tasks" -ForegroundColor Yellow
