...
[CmdletBinding()]
    Param (
        ...
        [Parameter(Mandatory=$False)][int]$PhysServerGBFU = 500,                                        ## Amount of space in GB used by physical servers that you don't charge for 
        [Parameter(Mandatory=$False)][int]$VirtServerGBFU = 500,                                        ## Amount of space in GB used by virtual servers that you don't charge for 
        [Parameter(Mandatory=$False)][int]$WorkstationGBFU = 100,                                       ## Amount of space in GB used by workstations that you don't charge for 
        [Parameter(Mandatory=$False)][Switch]$SendToCWM,                                                ## Send Usage Data to ConnectWise Manage
        [Parameter(Mandatory=$False)][Switch]$DebugCWM = $true,                                         ## Enable Debug for ConnectWise Manage
        [Parameter(Mandatory=$False)][String]$CWMAgreementName,                                         ## ConnectWise Manage Agreement Name (Prefered = 'CoveDataProtection' )
...
#region ----- Environment, Variables, Names and Paths ----
    ...
    $Cove2PSAProductMapping = @{
        ...
        "ContinuityQty"     = "Cove Continuity"                ## Prefered = 'Cove Continuity'
        "BilledGBQty"       = "Cove Billed GB"                 ## Prefered = 'Cove Billed GB'

    }  ## Cove to PSA Product Mapping


    ## Connectwise API connection information
    $CWMAPICreds = @{
