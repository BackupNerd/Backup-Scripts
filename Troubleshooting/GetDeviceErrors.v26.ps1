...
#region ----- Environment, Variables, Names and Paths ----
    ...
    if ($export -and $ExportPath) {$ExportPath = Join-path -path $ExportPath -childpath "Errors_$shortdate"}else{$ExportPath = Join-path -path $dir -childpath "Errors_$shortdate"}
