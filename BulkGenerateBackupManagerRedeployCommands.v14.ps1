...
<# ----- Behavior: ----
    # 
    # For user with the Standalone edition of SolarWinds Backup
...
# (No error)
    ...
    $Detail = $DeviceDetail | sort-object PartnerName | out-gridview -OutputMode Multiple -Title "Select all Required Devices and Click OK to Request PassPhrases"
