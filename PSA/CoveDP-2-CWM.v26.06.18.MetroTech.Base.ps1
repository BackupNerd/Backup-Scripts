        ...
        if ($ReadOnlyCWMUsageMode) {
            ...
            $CWMAdditions | Sort-Object { $_.product.identifier } | ForEach-Object {
                ...
                if ($isCove) {
                    ...
                    Add-content -Path $AuditLogFile -Value "`"$($CWMcompany.id)`",`"$($CWMcompany.name)`",`"$($CWMAgreement.name)`",`"$($CWMAgreement.type.name)`",`"$($_.product.identifier)`",`"$($_.description)`",`"$(if ($_.effectiveDate) { ([datetime]$_.effectiveDate).ToString('yyyy-MM-dd') } else { '' })`",$([Int]$current),$proposed"
                } else {
                    Write-Host ("  {0,-$maxIdLen}  {1,8:N2}  {2,8}  {3,8}" -f $productLabel, $current, '(n/a)', '') -ForegroundColor Gray
                    Add-content -Path $AuditLogFile -Value "`"$($CWMcompany.id)`",`"$($CWMcompany.name)`",`"$($CWMAgreement.name)`",`"$($CWMAgreement.type.name)`",`"$($_.product.identifier)`",`"$($_.description)`",`"$(if ($_.effectiveDate) { ([datetime]$_.effectiveDate).ToString('yyyy-MM-dd') } else { '' })`",$([Int]$current),`"`""
                }
            }
            Write-Host ''
        ...
        foreach ($CWMAddition in $CWMAdditions) {
            ...
            if ($($CWMAddition.product.identifier).$CWMAdditionSearchType($($CDP2CWMProductMapping.PhysicalServerQty))) {
                if ($CombineServers) {
                    ...
                    Add-content -Path $AuditLogFile -Value "`"$($CWMcompany.id)`",`"$($CWMcompany.name)`",`"$($CWMAgreement.name)`",`"$($CWMAgreement.type.name)`",`"$($CWMAddition.product.identifier)`",`"$($CWMAddition.description)`",`"$(if ($CWMAddition.effectiveDate) { ([datetime]$CWMAddition.effectiveDate).ToString('yyyy-MM-dd') } else { '' })`",$([Int]$CWMAddition.quantity),0"
                    ...
                    Add-content -Path $AuditLogFile -Value "`"$($CWMcompany.id)`",`"$($CWMcompany.name)`",`"$($CWMAgreement.name)`",`"$($CWMAgreement.type.name)`",`"$($CWMAddition.product.identifier)`",`"$($CWMAddition.description)`",`"$(if ($CWMAddition.effectiveDate) { ([datetime]$CWMAddition.effectiveDate).ToString('yyyy-MM-dd') } else { '' })`",$([Int]$CWMAddition.quantity),$($CDPusage.PhysicalServerQty)"
            ...
            if ($($CWMAddition.product.identifier).$CWMAdditionSearchType($($CDP2CWMProductMapping.VirtualServerQty))) {
                if ($CombineServers) {
                    ...
                    Add-content -Path $AuditLogFile -Value "`"$($CWMcompany.id)`",`"$($CWMcompany.name)`",`"$($CWMAgreement.name)`",`"$($CWMAgreement.type.name)`",`"$($CWMAddition.product.identifier)`",`"$($CWMAddition.description)`",`"$(if ($CWMAddition.effectiveDate) { ([datetime]$CWMAddition.effectiveDate).ToString('yyyy-MM-dd') } else { '' })`",$([Int]$CWMAddition.quantity),$($CDPusage.VirtualServerQty)"
            ...
            if ($($CWMAddition.product.identifier).$CWMAdditionSearchType($($CDP2CWMProductMapping.CombinedServerQty))) {
                if ($CombineServers) {
                    ...
                    Add-content -Path $AuditLogFile -Value "`"$($CWMcompany.id)`",`"$($CWMcompany.name)`",`"$($CWMAgreement.name)`",`"$($CWMAgreement.type.name)`",`"$($CWMAddition.product.identifier)`",`"$($CWMAddition.description)`",`"$(if ($CWMAddition.effectiveDate) { ([datetime]$CWMAddition.effectiveDate).ToString('yyyy-MM-dd') } else { '' })`",$([Int]$CWMAddition.quantity),$($CDPusage.CombinedServerQty)"
            ...
            if ($($CWMAddition.product.identifier).$CWMAdditionSearchType($($CDP2CWMProductMapping.WorkstationQty))) {
                ...
                Add-content -Path $AuditLogFile -Value "`"$($CWMcompany.id)`",`"$($CWMcompany.name)`",`"$($CWMAgreement.name)`",`"$($CWMAgreement.type.name)`",`"$($CWMAddition.product.identifier)`",`"$($CWMAddition.description)`",`"$(if ($CWMAddition.effectiveDate) { ([datetime]$CWMAddition.effectiveDate).ToString('yyyy-MM-dd') } else { '' })`",$([Int]$CWMAddition.quantity),$($CDPusage.WorkstationQty)"
            ...
            if ($($CWMAddition.product.identifier).$CWMAdditionSearchType($($CDP2CWMProductMapping.DocumentsQty))) {
                ...
                Add-content -Path $AuditLogFile -Value "`"$($CWMcompany.id)`",`"$($CWMcompany.name)`",`"$($CWMAgreement.name)`",`"$($CWMAgreement.type.name)`",`"$($CWMAddition.product.identifier)`",`"$($CWMAddition.description)`",`"$(if ($CWMAddition.effectiveDate) { ([datetime]$CWMAddition.effectiveDate).ToString('yyyy-MM-dd') } else { '' })`",$([Int]$CWMAddition.quantity),$($CDPusage.DocumentsQty)"
            ...
            if ($($CWMAddition.product.identifier).$CWMAdditionSearchType($($CDP2CWMProductMapping.RecoveryTestingQty))) {
                ...
                Add-content -Path $AuditLogFile -Value "`"$($CWMcompany.id)`",`"$($CWMcompany.name)`",`"$($CWMAgreement.name)`",`"$($CWMAgreement.type.name)`",`"$($CWMAddition.product.identifier)`",`"$($CWMAddition.description)`",`"$(if ($CWMAddition.effectiveDate) { ([datetime]$CWMAddition.effectiveDate).ToString('yyyy-MM-dd') } else { '' })`",$([Int]$CWMAddition.quantity),$($CDPusage.RecoveryTestingQty)"
            ...
            if ($($CWMAddition.product.identifier).$CWMAdditionSearchType($($CDP2CWMProductMapping.O365UsersQty))) {
                ...
                Add-content -Path $AuditLogFile -Value "`"$($CWMcompany.id)`",`"$($CWMcompany.name)`",`"$($CWMAgreement.name)`",`"$($CWMAgreement.type.name)`",`"$($CWMAddition.product.identifier)`",`"$($CWMAddition.description)`",`"$(if ($CWMAddition.effectiveDate) { ([datetime]$CWMAddition.effectiveDate).ToString('yyyy-MM-dd') } else { '' })`",$([Int]$CWMAddition.quantity),$($CDPusage.O365UsersQty)"
            ...
            if ($($CWMAddition.product.identifier).$CWMAdditionSearchType($($CDP2CWMProductMapping.CoveGBSelected))) {
                ...
                Add-content -Path $AuditLogFile -Value "`"$($CWMcompany.id)`",`"$($CWMcompany.name)`",`"$($CWMAgreement.name)`",`"$($CWMAgreement.type.name)`",`"$($CWMAddition.product.identifier)`",`"$($CWMAddition.description)`",`"$(if ($CWMAddition.effectiveDate) { ([datetime]$CWMAddition.effectiveDate).ToString('yyyy-MM-dd') } else { '' })`",$([Int]$CWMAddition.quantity),$($CDPusage.CoveGBSelected)"
